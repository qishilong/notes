...
![Context can skip updating components until you read the value out of it. Then it's back to memoization.](https://qiniucloud.qishilong.space/images/context-chaos.png)
