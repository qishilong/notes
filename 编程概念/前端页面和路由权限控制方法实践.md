...
```ts
export const adminKeys = ['ADMIN', 'xxx', '...'];
```
...
# NEXT_PUBLIC_POC_CLOSE_MENU=datasets,inference/model/manage
# USS环境地址
NEXT_PUBLIC_DEVELOPMENT_HOST=https://xxx.com
# POC环境地址
NEXT_PUBLIC_POC_HOST=https://xxx.com
```
  ...
  const fetchUserInfo = useCallback(() => {
    ...
    getUserInfo()
      .then((res) => {
        ...
        Cookies.set(USER_JWT_KEY, res.data?.token || '', {expires: 1, domain: 'xxx.com'});
