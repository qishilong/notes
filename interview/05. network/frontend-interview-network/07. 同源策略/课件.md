...
![image-20210916104747296](https://qiniucloud.qishilong.space/images/202307311332865.png)

同源策略对 ajax 的跨域限制的最为*凶狠*，默认情况下，它不允许 ajax 访问跨域资源

![image-20210916105741041](https://qiniucloud.qishilong.space/images/202307311332781.png)
