      ...
      <Stack.Navigator>
        ...
        {/* 更多电影 */}
         <Stack.Screen
          name="More"
          options={{
            header : ({navigation})=>(<MoreHeader type="moreMovie" navigation={navigation}/>),
            animation:"none"
          }}
        >
          {
            ()=>(
              <topTab.Navigator>
                <topTab.Screen name="正在热映" component={OnShowScreen}></topTab.Screen>
                <topTab.Screen name="即将上映" component={ComingSoonScreen}></topTab.Screen>
              </topTab.Navigator>
            )
          }
        </Stack.Screen>
