...
Array.prototype.myReduce = function (callback: Function, initialValue: any): any {
    ...
    } else if (this.length === 1 && initialValue || !this.length && initialValue === undefined) {
...
console.log(Array.prototype.myReduce.call(arrayLike, (x: any, y: any) => x + y));