...
`WindowEventHandlers` 混入（mixin）中的 `onpopstate` 属性是用于处理 window 对象上的 [`popstate`](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/popstate_event) 事件的[事件处理程序 (en-US)](https://developer.mozilla.org/en-US/docs/Web/Events/Event_handlers)。
...
## [语法](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/popstate_event#语法)
...
## [示例](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/popstate_event#示例)
