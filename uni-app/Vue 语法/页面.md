...
## [#](https://zh.uniapp.dcloud.io/tutorial/page.html#页面调用接口)页面调用接口
...
但`uni-app`框架有自己的窗口管理机制，请不要自己创建和销毁webview，如有需求覆盖子窗体上去，请使用[原生子窗体subNvue](https://zh.uniapp.dcloud.io/api/window/subNVues)。
