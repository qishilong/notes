...
![img](https://qiniucloud.qishilong.space/images/320px-Riffle_shuffle.jpg)

## Fisher and Yates 的原始版

![img](https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Biologist_and_statistician_Ronald_Fisher.jpg/189px-Biologist_and_statistician_Ronald_Fisher.jpg)
 ...
 * @param array 任意类型数组
 */
export const shuffleFn = (array: any[]) => {
	for (let i = array.length - 1; i >= 0; i--) {
		const index = getRandom(0, i);
